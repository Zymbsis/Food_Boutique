...
import { createOptionFromCategory, createOptionFromSortParams } from 'utils';

export const selectKeyword = state => state.requestParams.requestParams.keyword;
export const selectCategory = state => state.requestParams.requestParams.category;
...
export const selectDisplayedCategory = createSelector([selectCategory], category =>
  createOptionFromCategory(category)
);

export const selectDisplayedSortParams = createSelector([selectSortParams], sortParams =>
  createOptionFromSortParams(sortParams)
);

...
export const selectTotalPages = state =>
  state.productLists.allProducts.totalPages;
export const selectIsAllProductsLoading = state =>
  state.productLists.allProducts.isLoading;
export const selectIsAllProductsError = state =>
  state.productLists.allProducts.isError;

export const selectPopularProductsList = state =>
  state.productLists.popularProducts.popularProductsList;
export const selectIsPopularProductsLoading = state =>
  state.productLists.popularProducts.isLoading;
export const selectIsPopularProductsError = state =>
  state.productLists.popularProducts.isError;
...
export const selectIsDiscountProductsError = state =>
  state.productLists.discountProducts.isError;
